...
## 1. Project Overview
This repository contains the source code, data pipelines, and research findings for the `u3-draw-desktop` project, developed as part of a proprietary quantitative research environment.
